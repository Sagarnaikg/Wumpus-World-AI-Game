    ...
    return (
      <div class="col">
        <Game
          ...
          updateArrows={this.onUpdateArrows}
          cheatMode={this.state.cheat}
        ...
        <div class="gamePlayOptions mt-3">
          <div class="row">
            <div class="col text-muted mb-2">Grid Size</div>
          </div>
            ...
            <div class="col-auto">
              <div class="panel panel-default">
                <div
                  ...
                  data-target="#knowledgebaseContainer"
                >
